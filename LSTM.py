...
MODEL_SAVE_PATH = "best_lstm_future72hr_feature_model.pth"
RESULT_SAVE_PATH = "lstm_future72hr_feature_result.xlsx"
...
def build_clean_features(df, sheet_name):
    ...
    for bad_col in forbidden_cols:
        if bad_col in feature_cols:
            raise ValueError(
                f"Error: {bad_col} was added into feature_cols. Please check the code."
            )
