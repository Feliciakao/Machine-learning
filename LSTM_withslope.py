# =========================================================
# LSTM for Future 72hr Maintenance Prediction
# Clean Feature + Rolling Slope Version
# Threshold sweep on VAL, then evaluate TEST
# Epoch: MAX_EPOCHS=200, MIN_EPOCHS=30, PATIENCE=30
# =========================================================
...
# 這個 THRESHOLD 只作為預設紀錄用
# 實際最後會用 VAL 找到的 best_val_threshold
THRESHOLD = 0.30
...
MODEL_SAVE_PATH = "best_lstm_future72hr_slope_feature_model.pth"
RESULT_SAVE_PATH = "lstm_future72hr_slope_feature_result.xlsx"
...
class LSTMMaintenanceModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout):
        super(LSTMMaintenanceModel, self).__init__()
...
def evaluate_by_threshold(y_true, maintenance_prob, threshold):
    # 如果 P(after72hr=0) >= threshold，就預測為 0，也就是未來72hr會保養
...
# =========================================================
# 14. Training with New Early Stopping
# =========================================================
...
# =========================================================
# 18. Evaluate TEST with best VAL threshold
# =========================================================
...
# =========================================================
# 19. 使用 best VAL threshold 產生 train / val / test 預測結果
# =========================================================
...
test_final_summary_df = pd.DataFrame([{
    ...
    "test_accuracy": test_result_with_best_val_th["accuracy"],
    "test_precision_after72hr_0": test_result_with_best_val_th["precision_maintenance"],
    "test_recall_after72hr_0": test_result_with_best_val_th["recall_maintenance"],
    "test_f1_after72hr_0": test_result_with_best_val_th["f1_maintenance"],
